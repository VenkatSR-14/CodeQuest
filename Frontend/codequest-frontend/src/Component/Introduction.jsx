          ...
          <header className="absolute inset-x-0 top-0 z-50">
            <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
              ...
              <a href="/register" className="font-semibold text-indigo-600 hover:text-white">
                ...
                <div className="relative rounded-full ml-3 px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:bg-indigo-500 hover:ring-indigo-500">
                  <a href="/login" className="font-semibold text-indigo-600 hover:text-white">
                    <span aria-hidden="true" className="absolute inset-0" />
            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              ...
              <div className="text-center">
                <h1 className="text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
                    Empower your journey with tailored coding challenges
                </h1>
                <p className="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
                Explore, practice, and master programming with challenges crafted for coders of all levels. Build skills, grow confidence, and achieve your goals.
                </p>
