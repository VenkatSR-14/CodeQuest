...
const Register = () => {
  return (
    ...
    <form className='mb-5'>
        <p className='mt-5 text-4xl font-bold text-gray-900 text-center'>Begin your Quest Here!</p>
            ...
            <div className="sm:col-span-4">
              ...
              <div className="mt-2">
                <div className="flex items-center rounded-md bg-white pl-3 outline outline-1 -outline-offset-1 outline-gray-300 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                  <div className="shrink-0 select-none text-base text-gray-500 sm:text-sm/6">codequest.com/</div>
                  <input
                    id="username"
                    name="username"
                    type="text"
